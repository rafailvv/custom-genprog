...
public class LogReportBuilderTest {
    ...
    private List<String> sampleLogs() {
        return Arrays.asList(
            ...
            "2026-01-01T10:00:03|/users|200|80",
            "2026-01-01T10:00:04|/users|404|70",
            "2026-01-01T10:00:05|/health|200|10",
            "2026-01-01T10:00:06|/users|500|90",
    ...
    public void aggregate_countsSuccessAndFailure() {
        ...
        assertEquals(1, stats.get("/users").successCount);
        assertEquals(2, stats.get("/users").failCount);
    }
    ...
    public void topFailingEndpoints_ordersByFailureCountThenLatency() {
        ...
        assertEquals("/users#2#80", top.get(1));
    }
    ...
    public void buildSummaryLine_forKnownPath() {
        assertEquals("/users:1:2:80", LogReportBuilder.buildSummaryLine(sampleLogs(), "/users"));
    }
}
